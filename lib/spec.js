...
rules = {
    "GS001-DEPR-PURL": {
        "level": "error",
        "rule": "Replace {{pageUrl}} with {{page_url}}."
    },
    "GS001-DEPR-MD": {
        "level": "error",
        "rule": "Usage of {{meta_description}} is deprecated."
    },
    "GS001-DEPR-IMG": {
        "level": "error",
        "rule": "Replace the {{image}} helper with {{feature_image}}, {{cover_image}} or {{profile_image}}."
    },
    "GS001-DEPR-AIMG": {
        "level": "error",
        "rule": "Replace the {{author.image}} helper with {{author.profile_image}}."
    },
    "GS001-DEPR-PIMG": {
        "level": "error",
        "rule": "Replace the {{post.image}} helper with {{post.feature_image}}."
    },
    "GS001-DEPR-BC": {
        "level": "error",
        "rule": "Replace the {{@blog.cover}} helper with {{@blog.cover_image}}."
    },
    "GS001-DEPR-AC": {
        "level": "error",
        "rule": "Replace the {{author.cover}} helper with {{author.cover_image}}."
    },
    "GS001-DEPR-TIMG": {
        "level": "error",
        "rule": "Replace the {{tag.image}} helper with {{tag.feature_image}}."
    },
    "GS001-DEPR-PPP": {
        "level": "error",
        "rule": "Replace {{@blog.posts_per_page}} with {{@config.posts_per_page}}."
    },
    "GS001-DEPR-C0H": {
        "level": "error",
