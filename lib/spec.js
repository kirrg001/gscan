...
rules = {
    ...
    "GS010-PJ-NAME-LC": {
        "level": "error",
        "rule": "package.json `name` must be lowercase."
    },
    "GS010-PJ-NAME-HY": {
        "level": "error",
        "rule": "package.json `name` must be hyphenated."
    },
    "GS010-PJ-NAME-REQ": {
        "level": "error",
    ...
    "GS010-PJ-VERSION-SEM": {
        "level": "error",
        "rule": "package.json `version` must be semver compliant."
    },
    "GS010-PJ-VERSION-REQ": {
        "level": "error",
        "rule": "package.json `version` is required."
    },
    "GS010-PJ-AUT-EM-VAL": {
        "level": "error",
        "rule": "package.json `author.email` must be valid."
    },
    "GS010-PJ-CONF-PPP": {
        "level": "recommendation",
        "rule": "package.json `config.page_per_post` is recommended. Otherwise, it falls back to 5."
    },
    "GS010-PJ-CONF-PPP-INT": {
        "level": "error",
        "rule": "package.json `config.page_per_post` should be integer."
    },
    "GS010-PJ-AUT-EM-REQ": {
        "level": "error",
        "rule": "package.json `author.email` is required."
    },
    "GS020-INDEX-REQ": {
        "level": "error",
